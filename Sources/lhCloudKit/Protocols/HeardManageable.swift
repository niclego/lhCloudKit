...
public protocol HeardManageable: Sendable {
    ...
    func getNearbyHeardActivityFeed(from location: CLLocation, radius: CGFloat, resultsLimit: Int) async throws -> ([Heard], CKQueryOperation.Cursor?)
    ...
    func continueNearbyHeardActivityFeed(cursor: CKQueryOperation.Cursor, resultsLimit: Int) async throws -> ([Heard], CKQueryOperation.Cursor?)
